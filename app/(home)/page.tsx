      ...
      <div className="mx-auto flex max-w-screen-xl flex-col gap-10">
        ...
        <section className="flex flex-col items-center justify-center gap-10 px-5 py-10 lg:flex-row">
          ...
          <div className="flex max-w-xl flex-col gap-5">
            ...
            <p className="text-lg">
              La historia de las grandes ligas de fútbol es un viaje fascinante que ha dejado una huella imborrable en
              el deporte. Desde sus inicios, estas ligas han sido el hogar de innumerables talentos que han elevado el
              juego a nuevas alturas.
            </p>
            <p className="text-lg">
