...
echo ""
printf "${BLUE}================================${NC}\n"
printf "${BLUE}  Major League Database Default    ${NC}\n"
printf "${BLUE}================================${NC}\n"
echo ""

# Ask for environment
echo "¿En qué entorno deseas ejecutar el default?"
...
print_info "Ejecutando default en entorno: $ENV_NAME"
echo ""
...
echo ""
print_success "Default completado exitosamente en entorno $ENV_NAME"
echo ""
